...
fit_gene_models <- function(genes, data) {
  res <- list()
  for (gene in genes) {
    formula <- as.formula(paste(gene, "~ Response * cluster_annot"))
...
write.xlsx(full_res_coef_df, file="../figPlots/DEA/IMC_DEA_LMER_stats_None.xlsx", sheetName="WholeDataset_Stats", row.names=TRUE, col.names = TRUE)
write.xlsx(IntraTLS_res_coef_df, file="../figPlots/DEA/IMC_DEA_LMER_stats_None.xlsx", sheetName="IntraTLS_Stats", append = TRUE, row.names=TRUE, col.names = TRUE)
write.xlsx(PeriTLS_res_coef_df, file="../figPlots/DEA/IMC_DEA_LMER_stats_None.xlsx", sheetName="PeriTLS_Stats", append = TRUE, row.names=TRUE, col.names = TRUE)
write.xlsx(allTLS_res_coef_df, file="../figPlots/DEA/IMC_DEA_LMER_stats_None.xlsx", sheetName="allTLS_Stats", append = TRUE, row.names=TRUE, col.names = TRUE)
write.xlsx(LN_res_coef_df, file="../figPlots/DEA/IMC_DEA_LMER_stats_None.xlsx", sheetName="LN_Stats", append = TRUE, row.names=TRUE, col.names = TRUE)
