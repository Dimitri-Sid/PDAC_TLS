...
#alter the function to change label sizes
...
counts_table <- table(aggr_PeriTLS$cluster_annot, aggr_PeriTLS$sample_id)
...
# Set up Colors
clusterlevels <- unique(aggr_PeriTLS$cluster_annot)
...
pdf("../figPlots/composition/CompositionPlots_clusterCelltype_PeriTLS.pdf", height = 3, width = 4)
...
saveRDS(ggdf, "../figPlots/composition/PeriTLS_props_ggdf.RDS")
