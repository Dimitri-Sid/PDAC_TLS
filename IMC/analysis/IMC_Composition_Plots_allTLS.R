...
counts_table <- table(aggr_allTLS$cluster_annot, aggr_allTLS$sample_id)
...
# Set up Colors
clusterlevels <- unique(aggr_allTLS$cluster_annot)
...
pdf("../figPlots/composition/CompositionPlots_clusterCelltype_allTLS.pdf", height = 3, width = 4)
...
saveRDS(ggdf, "../figPlots/composition/allTLS_props_ggdf.RDS")
